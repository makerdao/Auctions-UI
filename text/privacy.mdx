...
This Privacy Policy provides our privacy policy regarding the nature, purpose, use, and sharing of personal data or other information collected from the users of the website auctions.makerdao.com and other websites which use subdomains of makerdao.com (the "Site"). This Privacy Policy also includes the Cookie We are committed to protecting and respecting your privacy. Please read this carefully as this Privacy Policy is legally binding when you use the Site.

As used in this Privacy Policy, "we", "us" or "our" refers to Maker Ecosystem Growth Holdings, Inc. You can reach us with any requests relating to this Privacy Policy via contact details provided below.
...
*   Website usage information, such as:
    ...
    *   Button clicks,
    *   Input form changes (without the values being tracked),
    *   Errors.
...
We use public Ethereum addresses to identify a user’s journey through our product. We group and analyse these user journeys collectively in order to improve our product user experience. We do not use this data for any purpose at an individual user level.
...
You may contact us by email to the following email address: [legal@makerdao.com](mailto:legal@makerdao.com). We use the data that you provide in an email to us, which you may give voluntarily, only in order to answer your contact question or to reply to your email in the best possible manner.
...
Please contact us with questions, comments, or concerns regarding our Privacy Policy as well as with any requests at [legal@makerdao.com](mailto:legal@makerdao.com).
